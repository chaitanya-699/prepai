  ...
  return (
    <article className="auth-card auth-card--register">
      ...
      <header className="auth-card__header">
        ...
        <p>
          Build a fresh profile and start a clean onboarding path with a bold, guided setup.
        </p>
      </header>
      ...
      <form className="auth-form" onSubmit={handleSubmit}>
        ...
        <div className="auth-row auth-row--triple">
          <label className="auth-field auth-field--compact">
            <span>Password</span>
            <input type="password" name="password" placeholder="Create a password" autoComplete="new-password" value={password} onChange={(e) => setPassword(e.target.value)} />
          </label>
        </div>
      ...
      <footer className="auth-card__footer">
        <span className="auth-meta">Designed for fast enrollment and clear next steps.</span>
      </footer>
    </article>
  )
}
